...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'll.core.adminmenu' => 'getLl_Core_AdminmenuService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LLCoreBundle', ($this->targetDirs[2].'/Resources/LLCoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LLCoreBundle', ($this->targetDirs[3].'\\src\\LL\\CoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'll.core.adminmenu', 1 => 'showMenu'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'll-project', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\LL\\CoreBundle\\Entity'))), 'LL\\CoreBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('LLCoreBundle' => 'LL\\CoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e3c36b37bd4ce8571371edf3b3c0c5a7ebed42e856a90dcca29881aba0cd44f5');
    ...
    /**
     * Gets the 'll.core.adminmenu' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LL\CoreBundle\Listener\AdminMenu A LL\CoreBundle\Listener\AdminMenu instance.
     */
    protected function getLl_Core_AdminmenuService()
    {
        return $this->services['ll.core.adminmenu'] = new \LL\CoreBundle\Listener\AdminMenu($this->get('security.context'), $this->get('twig'), array('product' => array('beautyName' => 'Produits', 'menu' => 'products', 'class' => 'LL\\CoreBundle\\Entity\\Product', 'form' => 'LL\\CoreBundle\\Form\\ProductType', 'views' => 'product', 'listProperties' => array('name' => array('dataName' => 'name', 'beautyName' => 'Nom', 'type' => 'string'), 'isAllergen' => array('dataName' => 'isAllergen', 'beautyName' => 'Produit allergène', 'type' => 'boolean'), 'priceHt' => array('dataName' => 'priceHt', 'beautyName' => 'Prix HT', 'type' => 'money'), 'unity' => array('dataName' => 'unity', 'beautyName' => 'Unité', 'type' => 'string'), 'category' => array('dataName' => 'category', 'beautyName' => 'Catégorie', 'type' => 'string'), 'provider' => array('dataName' => 'provider', 'beautyName' => 'Fournisseur', 'type' => 'string')), 'unique' => false), 'provider' => array('beautyName' => 'Fournisseurs', 'menu' => 'provider', 'class' => 'LL\\CoreBundle\\Entity\\Provider', 'form' => 'LL\\CoreBundle\\Form\\ProviderType', 'views' => 'default', 'listProperties' => array('name' => array('dataName' => 'name', 'beautyName' => 'Nom', 'type' => 'string')), 'unique' => false), 'production' => array('beautyName' => 'Fiche de fabrication', 'menu' => 'production', 'class' => 'LL\\CoreBundle\\Entity\\Production', 'form' => 'LL\\CoreBundle\\Form\\ProductionType', 'views' => 'production', 'listProperties' => array('name' => array('dataName' => 'name', 'beautyName' => 'Nom', 'type' => 'string'), 'category' => array('dataName' => 'category', 'beautyName' => 'Catégorie', 'type' => 'string'), 'cookingTime' => array('dataName' => 'cookingTime', 'beautyName' => 'Tps de cuisson', 'type' => 'time'), 'preparationTime' => array('dataName' => 'preparationTime', 'beautyName' => 'Tps de préparation', 'type' => 'time')), 'unique' => false)), array('products' => array('beautyName' => 'Produits'), 'provider' => array('beautyName' => 'Fournisseurs'), 'production' => array('beautyName' => 'Fiche de fabrication')));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'AsseticBundle', 3 => 'TwigBundle', 4 => 'MonologBundle', 5 => 'SwiftmailerBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'LLCoreBundle', 9 => 'StofDoctrineExtensionsBundle', 10 => 'IvoryCKEditorBundle', 11 => 'DebugBundle', 12 => 'WebProfilerBundle', 13 => 'SensioDistributionBundle', 14 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\LL\\CoreBundle/Resources/views'), 'LLCore');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('df81c00aa720e87fd961da33fcabb3f33a0f6e4b');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5742b0ee6a5a55.22938138')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LLCoreBundle' => 'LL\\CoreBundle\\LLCoreBundle',
            ...
            'secret' => 'df81c00aa720e87fd961da33fcabb3f33a0f6e4b',
            'locale' => 'en',
            ...
            'kernel.secret' => 'df81c00aa720e87fd961da33fcabb3f33a0f6e4b',
